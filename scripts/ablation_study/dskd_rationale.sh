...
CKPT_PATH="cm/home/minhla4/dskd_ot_rationale-main/epoch7_step5005_loss2.0140_rougel27.9030"
...
# runtime
PRECISION="bf16"
CRITERION="dual_space_kd_with_cma" # xem list criterion trong code/criterions/__init__.py
...
for KD_RATE in "${KD_RATES[@]}"; do
    ...
    OPTS=""
    # param để chọn xem dùng dataset nào để train
    ...
    echo "Running KD_RATE=${KD_RATE}, logs: ${SAVE_PATH}/train.log"
