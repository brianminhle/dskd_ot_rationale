...
TEACHER_MODEL_PATH="/mnt/bn/magellan-product-llm-data/tu.vu/matrix_one/dskd_ot_rationale/outputs/qwen/Qwen1.5-1.8B/sft/raw/alpaca/criterion=cross_entropy__default-fp16__epoch=10__bsz=4x2x4=32__lr=0.00002/epoch8_step2600_loss2.9104_rougel33.8909"
# data
DATASET_NAME="alpaca" # 
DATA_DIR="${BASE_PATH}/data/${DATASET_NAME}/"
DATASET='rationale' # raw , rationale
# task
TASK="dual_space_kd_with_cma_ot_rationale"
# hp
BATCH_SIZE=4
LR=0.0005
GRAD_ACC=2
...
# runtime
PRECISION="bf16"
CRITERION="dual_space_kd_with_cma_ot_rationale" # xem list criterion trong code/criterions/__init__.py
