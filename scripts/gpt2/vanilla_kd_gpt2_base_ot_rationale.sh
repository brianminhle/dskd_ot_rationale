...
TEACHER_MODEL_PATH="/home/aac/DSKD/outputs/gpt2/gpt2-xlarge/sft/raw/alpaca/criterion=cross_entropy__default-fp16__epoch=10__bsz=4x2x4=32__lr=0.00002/epoch10_step3250_loss2.1139_rougel30.3165"
# distiller
...
# ${CMD}
${CMD} \
>> ${SAVE_PATH}/dolly_gpt2_same_vocab_ot_rationale_07_train.log 2>&1 &
