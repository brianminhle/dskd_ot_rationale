...
TEACHER_PEFT_PATH="/mnt/bn/magellan-product-llm-data/tu.vu/matrix_one/dskd_ot_rationale/outputs/qwen/Qwen2.5-7B-Instruct/sft/raw/dolly/criterion=cross_entropy__lora-rank=256-alpha=8-dropout=0.1-bf16__epoch=10__bsz=8x1x4=32__lr=0.001/epoch8_step2864_loss2.1847_rougel32.1715"
PROJECTOR_CONFIG_PATH="${BASE_PATH}/configs/projector_config.json"
PROJECTOR_LR=0.001
# data
DATASET_NAME="dolly" # 
DATA_DIR="${BASE_PATH}/data/${DATASET_NAME}/"
DATASET='rationale' # raw , rationale
# task
TASK="universal_logit_distillation_ot_rationale"
# hp
BATCH_SIZE=2
LR=0.001
GRAD_ACC=4
...
# runtime
PRECISION="bf16"
CRITERION="universal_logit_distillation_ot_rationale" 
...
# CMD="/opt/conda/envs/py_3.10/bin/torchrun ${DISTRIBUTED_ARGS} ${BASE_PATH}/code/distillation.py ${OPTS}"
CMD="torchrun ${DISTRIBUTED_ARGS} ${BASE_PATH}/code/distillation.py ${OPTS}"

${CMD} \
>> ${SAVE_PATH}/train_uld_ce_ot_001.log 2>&1
