...
# model
BASE_PATH=/home/aac/dskd_ot_rationale
CKPT_TYPE="tinyllama"
...
TEACHER_PEFT_PATH="/home/aac/dskd_ot_rationale/outputs/llama2/llama2-7b-hf/sft/raw/dolly/criterion=cross_entropy__lora-rank=256-alpha=8-dropout=0.1-bf16__epoch=10__bsz=8x1x4=32__lr=0.001/epoch9_step3222_loss2.7038_rougel32.8270"
# data
DATASET_NAME="dolly" # 
...
PROJECTOR_LR=0.001
# task
TASK="various_divergence_ot_rationale"
# hp
BATCH_SIZE=4
LR=0.001
GRAD_ACC=2
...
# runtime
PRECISION="bf16"
CRITERION="various_divergence_ot_rationale"
