...
TEACHER_PEFT_PATH="/mnt/bn/magellan-product-llm-data/tu.vu/matrix_one/dskd_ot_rationale/outputs/mistral/mistral-7b-v0.1/sft/raw/dolly/criterion=cross_entropy__lora-rank=256-alpha=8-dropout=0.1-bf16__epoch=10__bsz=8x1x4=32__lr=0.001/epoch9_step3222_loss3.2696_rougel34.9315"
