...
TEACHER_PEFT_PATH="/home/aac/DSKD/outputs/llama2/llama2-7b-hf/sft/raw/alpaca/criterion=cross_entropy__lora-rank=256-alpha=8-dropout=0.1-bf16__epoch=10__bsz=8x1x4=32__lr=0.001/epoch10_step3250_loss2.3948_rougel35.7737"
# data
DATASET_NAME="alpaca" # 
...
# ${CMD}
${CMD} \
>> ${SAVE_PATH}/train_06_kd_rate.log 2>&1 &
# >> ${SAVE_PATH}/train_05_kd_rate.log 
